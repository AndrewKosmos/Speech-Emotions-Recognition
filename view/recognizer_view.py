...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pb_voice_start = QtWidgets.QPushButton(self.centralwidget)
        self.pb_voice_start.setObjectName("pb_voice_start")
        self.gridLayout.addWidget(self.pb_voice_start, 0, 1, 1, 1)
        ...
        self.pb_voice_stop = QtWidgets.QPushButton(self.centralwidget)
        self.pb_voice_stop.setObjectName("pb_voice_stop")
        self.gridLayout.addWidget(self.pb_voice_stop, 0, 2, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pb_voice_start.setText(_translate("MainWindow", "Запись голоса"))
        self.pb_open.setText(_translate("MainWindow", "Открыть файл"))
        self.pb_voice_stop.setText(_translate("MainWindow", "Остановить запись"))
